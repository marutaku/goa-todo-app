...
func NewLoginLoginFailed(body *LoginLoginFailedResponseBody) *auth.AuthFlowFailed {
	v := &auth.AuthFlowFailed{
...
func NewRegisterRegisterFailed(body *RegisterRegisterFailedResponseBody) *auth.AuthFlowFailed {
	v := &auth.AuthFlowFailed{
		Message: *body.Message,
		Name:    *body.Name,
	}
